...
class KundliData(BaseModel):
    ...
    varshaphal_planets: Any | None = None
    varshaphal_muntha: Any | None = None
    varshaphal_mudda_dasha: Any | None = None
    varshaphal_panchavargeeya_bala: Any | None = None
    varshaphal_harsha_bala: Any | None = None
    varshaphal_saham_points: Any | None = None
    varshaphal_yoga: Any | None = None
