...
- `CREDIT_CHECK_ENABLED` — meters sweeper generation against `astrologers.credits_balance`. Requires `credits_schema.sql` run in Supabase; `false` = unmetered (rollback switch).
